...
export default function Home(){
  ...
  const [missPenalty,setMissPenalty]=useState(50);
  ...
  async function pushCell(index:number){
    ...
    setMissPenalty(board.damage.includes(index)?2000:50);
