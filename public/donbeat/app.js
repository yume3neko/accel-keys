...
function updateVisualBpm(t,opacity){
 ...
 const n=visualBpmState(chart,t),format=v=>Number(v.toFixed(3)).toLocaleString('ja-JP',{maximumFractionDigits:3});
 const value='見た目 '+format(n.bpm)+' BPM × '+format(n.hs)+' HS'+(n.scroll!==1?' × '+format(n.scroll):'')+' = '+format(n.value)+' BPM';
