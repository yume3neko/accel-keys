...
root.rebuildTjaBranches=(chart,choices)=>({...chart,...compile({...chart._tja.meta},chart._tja.lines,new Set(),choices)});root.parseTJA=parseTJA;if(typeof module!=='undefined')module.exports={parseTJA};})(typeof window!=='undefined'?window:globalThis);
